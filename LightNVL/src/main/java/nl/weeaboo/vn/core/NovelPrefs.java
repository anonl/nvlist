...
public final class NovelPrefs {
    ...
    public static final Preference<Integer> WIDTH = Preference.newConstPreference("width", 1280, "Width",
    ...
    public static final Preference<Integer> HEIGHT = Preference.newConstPreference("height", 720, "Height",
