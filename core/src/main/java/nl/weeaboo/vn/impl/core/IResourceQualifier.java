 ...
 * can be added to the image folder ("img/" -> "img-1280x720/"). This allows you to have multiple versions of
 * the same resource side-by-side, letting the engine decide the most appropriate variant.
 */
